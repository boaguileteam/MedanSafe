...
public final class ActivityPrivacyPolicyBinding implements ViewBinding {
  ...
  @NonNull
  public final AppCompatButton btnUnderstood;

  @NonNull
  public final ConstraintLayout clHeader;

  private ActivityPrivacyPolicyBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView btnBack, @NonNull AppCompatButton btnUnderstood,
      @NonNull ConstraintLayout clHeader) {
    this.rootView = rootView;
    this.btnBack = btnBack;
    this.btnUnderstood = btnUnderstood;
  ...
  public static ActivityPrivacyPolicyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btnUnderstood;
      AppCompatButton btnUnderstood = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityPrivacyPolicyBinding((ConstraintLayout) rootView, btnBack, btnUnderstood,
          clHeader);
    }
