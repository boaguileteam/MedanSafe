...
public final class ActivitySplashBinding implements ViewBinding {
  ...
  private ActivitySplashBinding(@NonNull ConstraintLayout rootView, @NonNull View dot1,
      @NonNull View dot2, @NonNull View dot3, @NonNull ImageView imgLogo,
      @NonNull LinearLayout llAppName, @NonNull TextView tvTagline) {
    this.rootView = rootView;
    this.dot1 = dot1;
    this.dot2 = dot2;
    this.dot3 = dot3;
    this.imgLogo = imgLogo;
    this.llAppName = llAppName;
  ...
  public static ActivitySplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.ll_app_name;
      LinearLayout llAppName = ViewBindings.findChildViewById(rootView, id);
      if (llAppName == null) {
        break missingId;
      }
      ...
      return new ActivitySplashBinding((ConstraintLayout) rootView, dot1, dot2, dot3, imgLogo,
          llAppName, tvTagline);
    }
